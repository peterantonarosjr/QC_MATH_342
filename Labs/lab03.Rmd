...
```{r}
galtonModel = my_simple_ols(Galton$parent, Galton$child)
```
...
ggplot(Galton, aes(x = parent, y = child)) + 
  geom_point() + 
  geom_jitter() +
  geom_abline(intercept = galtonModel$b_0, slope = galtonModel$b_1, color = "blue", size = 1) +
